...
```
#### [Документация API](https://github.com/mikibouns/django_api_project2/blob/dev_2.1/api_app/templates/api_app/api_docs.html) находитсяя по данной ссылке, адрес из веб приложения http://127.0.0.1:8000/api-doc/
