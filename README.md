...
| HTTP Type | API URL | Коментарий |
|---------------|-----------|---------------|
| POST | /v1/ | Получаем список доступных адресов API |
| Параметры |  |
| Возвращаемые значение при успешной авторизации | ```[{"api_url": "http://127.0.0.1:8000/admin/", "method": "get", "comments": "Панель администратора(доступна только суперпользователю)"},{"api_url": "http://127.0.0.1:8000/v1/","method": "get","comments": "Описание доступных методов (этот документ)"}, ...]``` |
